"""
Non-interactive version of the Advanced Production Demo
Runs all demos automatically without user prompts
"""
    ...
    def generate_packet(self):
        ...
        if self.attack_active:
            if self.attack_type == 'ddos':
                ...
                src_port = random.choice([22, 23, 3389])
            ...
            src_port = random.choice([80, 443, 53])
...
def demo_swarm_intelligence():
    ...
    print("Processing distributed traffic...\n")
...
def main():
    ...
    print("\n[Starting Demo 1: ML Perception]\n")
    demo_ml_perception()

    print("\n[Starting Demo 2: Swarm Intelligence]\n")
    demo_swarm_intelligence()

    print("\n[Starting Demo 3: Model Persistence]\n")
